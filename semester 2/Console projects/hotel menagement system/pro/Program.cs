...
namespace pro
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           //Load functions
            DL.customerDL.readFromFileroom(customerpath);
            DL.customerDL.readFromFileproduct(customerpathforproducts);
            DL.productDL.readFromFile(currentproducts);
            DL.roomDL.readFromFile(roomsinfomation);
            DL.workerDL.readFromFile(workersinformation);
